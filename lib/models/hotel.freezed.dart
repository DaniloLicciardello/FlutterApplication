...
class _$HotelImpl implements _Hotel {
  ...
  @override
  String toString() {
    return 'Hotel(id: $id, name: $name, description: $description, mainPhoto: $mainPhoto, voteAverage: $voteAverage)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, name, description, mainPhoto, voteAverage);
